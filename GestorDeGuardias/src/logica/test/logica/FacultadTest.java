...
//        try {
//
//            facultad.annadirTrabajador("70101787233", "Mercedes Maria", "L�pez Gonz�lez", 'f');
...
//            facultad.annadirTrabajador("78092587290", "Fernanda Noemi", "Campos Mendieta", 'f');
...
//            facultad.annadirTrabajador("78111051339", "Marlene Estefania", "Novillo Jara", 'f');
//            facultad.annadirTrabajador("63040450933", "Johanna Sofia", "Perez Cabrera", 'f');
//            facultad.annadirTrabajador("70071327412", "Martha Patricia", "Morales Harris", 'f');
//            facultad.annadirTrabajador("85110233916", "Diana Luc�a", "I�iguez I�iguez", 'f');
//            facultad.annadirTrabajador("73122830205", "Jaime Vicente", "Chuchuca Serrano", Sexo.MASCULINO);
//            facultad.annadirTrabajador("91101144653", "Sahira Maribel", "Martinez Cepeda", 'f');
...
//            facultad.annadirTrabajador("66040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
...
//            facultad.annadirTrabajador("74102594455", "Marlene Alexandra", "Narvaez Calvachi", 'f');
...
//            facultad.annadirTrabajador("74061424753", "Raquel Alejandra", "Arcos Cabezas", 'f');
//            facultad.annadirTrabajador("81010751413", "Georgina Piedad", "Panchez Hernandez", 'f');
//            facultad.annadirTrabajador("92122025074", "Karina Monserrath", "Masache Alvarado", 'f');
...
//            facultad.annadirTrabajador("86092649453", "Lilli Lucia", "Romero Pacheco", 'f');
//            facultad.annadirTrabajador("94040884719", "Susana Del Rocio", "Andrade Soto", 'f');
...
//            facultad.annadirTrabajador("94010697432", "Lourdes Del Roc�o", "Lara Valencia", 'f');
//            facultad.annadirTrabajador("64122519575", "Fanny Margoth", "Ca�ar Caisalitin", 'f');
//            facultad.annadirTrabajador("76032257421", "Jorge Alfonso", "Llerena Vargas", Sexo.MASCULINO);
//
//            facultad.annadirEstudiante("05032394338", "Alexandra Elizabeth", "Carrion C�rdova", 'f');
...
//            facultad.annadirEstudiante("02011137116", "Karol Narcisa", "Macias Yanez", 'f');
//            facultad.annadirEstudiante("06021673071", "Elizzabeth Vanessa", "De Ring Salvador", 'f');
//            facultad.annadirEstudiante("02091027151", "Luz Mariuxi", "Murillo Calvache", 'f');
//            facultad.annadirEstudiante("01112526860", "Santander Rosero", "Luis Enrique", Sexo.MASCULINO);
//            facultad.annadirEstudiante("05051486014", "Gladys Monserrate", "Ord��ez Alem�n", 'f');
//            facultad.annadirEstudiante("01061965833", "Maria Jose", "Franco Pico", 'f');
//            facultad.annadirEstudiante("04092080501", "Diego Alejandro", "Redroban Becerra", Sexo.MASCULINO);
//            facultad.annadirEstudiante("05102048498", "Angela Lucciola", "Suarez Velasquez", 'f');
//            facultad.annadirEstudiante("06091298833", "Martha Fabiola", "Rizzo Gonzalez", 'f');
//            facultad.annadirEstudiante("02120755742", "Carlos Dionisio", "Sornoza Moran", Sexo.MASCULINO);
//            facultad.annadirEstudiante("04101954771", "Karen Gabriela", "Romero Zavala", 'f');
...
//            facultad.annadirEstudiante("01112288152", "Mireya Veronica", "Choez Caicedo", 'f');
...
//            facultad.annadirEstudiante("02041375955", "Jessica Rosa", "Macio Cueva", 'f');
...
//            facultad.annadirEstudiante("03081534231", "Nina Dolores", "Romero Delgado", 'f');
//            facultad.annadirEstudiante("04080235136", "Hilda Maria", "Molina Lopez", 'f');
//            facultad.annadirEstudiante("05022226625", "Luis Fernando", "Valarezo Lingen", Sexo.MASCULINO);
//            facultad.annadirEstudiante("01091895597", "Lilia Edith", "Garcia Anchundia", 'f');
//            facultad.annadirEstudiante("06091956525", "Enrique Sigifredo", "Centeno Mendoza", Sexo.MASCULINO);
//            facultad.annadirEstudiante("03121368195", "Ileana Azucena", "Luna Veliz", 'f');
//            facultad.annadirEstudiante("04042031731", "Carmen Lucila", "Jordan Medina", 'f');
...
//            facultad.annadirEstudiante("04020964790", "Virginia Azucena", "Trivi�o Bonilla", 'f');
//            facultad.annadirEstudiante("04090785292", "Ana Alegria", "Mero Delgado", 'f');
//            facultad.annadirEstudiante("04101759502", "Angel Leon", "Coloma Carrasco", Sexo.MASCULINO);
//            facultad.annadirEstudiante("04080841013", "Sylvia Ines", "Escalante Hernandez", 'f');
//            facultad.annadirEstudiante("03070968084", "Mario Francisco", "Cuvi Santacruz", Sexo.MASCULINO);
//            facultad.annadirEstudiante("01011349819", "Maria Jose", "Friere Almeida", 'f');
//            facultad.annadirEstudiante("06090627399", "Jenny Soraya", "Mero O�a", 'f');
//
...
//        }
    ...
    public void annadirEstudiante_NullCiShouldThrowMEException() throws EntradaInvalidaException {
        ...
        try {
            //facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
            facultad.annadirEstudiante(null, "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_InvalidCiLongitudShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("0604087833712123", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_InvalidCiCaracteresShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("060408783as", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_InvalidCiMesShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06130878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_InvalidCiDia1ShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06043178337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_InvalidCiDia2ShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06053278337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
            validaError = e.getErrores().contains("Carnet de identidad no v�lido: Dia incorrecto.");
        }
        assertTrue(validaError);
    ...
    public void annadirEstudiante_InvalidCiDia3ShouldThrowMEException() throws EntradaInvalidaException {
        ...
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06023278337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
            validaError = e.getErrores().contains("Carnet de identidad no v�lido: Dia incorrecto.");
        }
        assertTrue(validaError);
    ...
    public void annadirEstudiante_NullNombreShouldThrowMEException() throws EntradaInvalidaException {
        ...
        try {
            //facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
            facultad.annadirEstudiante("06040878337", null, "Pazmi�o Arregui", 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_NullApellidoShouldThrowMEException() throws EntradaInvalidaException {
        ...
        try {
            //facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
            facultad.annadirEstudiante("06040878337", "Mireya Katerine", null, 'f');
        } catch (MultiplesErroresException e) {
    ...
    public void annadirEstudiante_CiDuplicadoShouldThrowEIException() throws MultiplesErroresException {
        ...
        try {
            facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
            facultad.annadirEstudiante("06040878337", "Mireya Katerine1", "Pazmi�o Arregui1", 'f');
        } catch (EntradaInvalidaException e) {
    ...
    public void annadirEstudiante_Success() throws MultiplesErroresException, EntradaInvalidaException {
        Facultad facultad = new Facultad();
        facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", 'f');
        assertNotNull(facultad.buscarPersona("06040878337"));
    }
...
//		try {
//			facultad.annadirTrabajador("70101787233", "Mercedes Maria", "L�pez Gonz�lez", Sexo.FEMENINO );
//			facultad.annadirTrabajador("70101787233", "Mercedes Maria1", "L�pez Gonz�lez1", 'f');
//		} catch (EntradaInvalidaException e) {
...
//
    ...
    public void darBaja_Success() throws MultiplesErroresException, EntradaInvalidaException {
        ...
        assertEquals(facultad.buscarPersona("70101787233").getBaja(), fechaBaja);
    }
