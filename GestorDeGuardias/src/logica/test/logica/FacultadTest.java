...
public class FacultadTest {
    ...
    @Test
    public void annadirEstudiante_sexoNoEspecificadoShouldThrowEIException() throws MultiplesErroresException, EntradaInvalidaException {
        Facultad facultad = new Facultad();
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", null);
        } catch (MultiplesErroresException e) {
    ...
    @Test
    public void annadirEstudiante_sexoNoCorrespondeShouldThrowEIException() throws MultiplesErroresException, EntradaInvalidaException {
        Facultad facultad = new Facultad();
        boolean validaError = false;
        try {
            facultad.annadirEstudiante("06040878337", "Mireya Katerine", "Pazmi�o Arregui", Sexo.MASCULINO);
        } catch (MultiplesErroresException e) {
...
//
    ...
    public void darBaja_Success() throws MultiplesErroresException, EntradaInvalidaException {
        ...
        assertEquals(facultad.buscarPersona("70101787233").getFechaDeBaja(), fechaBaja);
    }
